...
<ol class="track-progress" data-steps="3">
   <li class="done">
    <span><a href="<%= request.getContextPath()%>/Pages/FormRequesterUp.jsp">Enter Informations</a></span>
     <i></i>
   </li><!--
<<<<<<< HEAD
--><li class="done">
...
<p style='padding-left:10px;'>Reward per Submission:<input type="number" name="number3" id="nom4" value="0.01" min="0.01" step="0.01"></p>
<p style='padding-left:10px;'>Total Worker Rewards:<input type="text" name="number4" id="nom5" placeholder="Total worker Rewards"></p>
<p style='padding-left:10px;'>Total Cost:<input type="text" name="number5" id="nom5" placeholder="Total Cost"></p>
<div style='background-color:#ff8080;'>You Should Pay:
